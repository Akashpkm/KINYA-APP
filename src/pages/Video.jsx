...
function Video() {
  ...
  const videoItems = [
    ...
    
    {
      ...
      duration: '9:32',
      videoUrl: 'https://youtu.be/xpXXRgzLYxc?si=gDSmCSCbW5VmTMsg', // Youtube video
      youtubeId: 'xpXXRgzLYxc',
      type: 'youtube'
    },
    {
      id: 7,
  ...
  const featuredVideo = [
   { id: 0,
    ...
    type: 'youtube'
     ...
     { id: 1,
    title: 'Introduction to HOPE 10000',
    description: 'The HOPE10000 is engineered to deliver precision, stable fluidics, and reliable performance for modern vitreoretinal surgery.',
     thumbnail: './THUMB/INTROHOPE.png',
    duration: '2:19',
    videoUrl: 'https://www.youtube.com/embed/1kwkbo0QeRg?si=zW9jAFPVoWJ8j1Yn', // Local video
    youtubeId: '1kwkbo0QeRg',
    type: 'youtube'
   },
  ];
          ...
          <div className="featured-video" key={featuredVideo.id}>
            ...
            <div className="video-details">
              ...
              <div className="video-meta">
                ...
                <span><i className="fas fa-eye"></i> 1,145 views</span>
              </div>
              <button 
